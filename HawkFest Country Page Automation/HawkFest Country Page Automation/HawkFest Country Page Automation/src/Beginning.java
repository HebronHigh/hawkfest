...
public class Beginning {
	...
	private void printStyleSheetToHTMLFile(PrintWriter out) {
		...
		out.println("\t\t}");
		out.println("");
		out.println("\t\t/* This will style PDFs to fit to the width of the screen */");
		out.println("\t\tarticle iframe {");
		out.println("\t\t\twidth: 65vmin;");
		out.println("\t\t\theight: 75vmin;");
		out.println("\t\t}");
		out.println("");
		out.println("\t\t/* This will style audio files that are used */");
		out.println("\t\tarticle audio {");
		out.println("\t\t\twidth: 65vmin;");
		out.println("\t\t\theight: 5vmin;");
		out.println("\t\t}");
		out.println("");
